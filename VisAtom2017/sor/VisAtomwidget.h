...
public:
	...
	//Clipping routines
	VisAtomCliper*GetCurrentClipper()
	     {return m_Cliper[m_currentCliper];}
	void  SetCurrentCliper(int current, bool redraw=true);
	void  SetCliperParameters(VisAtomCliper*sor);
